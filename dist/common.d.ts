...
export declare const register: (context: Context, tabIndexId: string, domElementRef: import("react").RefObject<any>, disabled: boolean, isGrid?: boolean | undefined) => void;
export declare const changeDisabled: (context: Context, tabIndexId: string, domElementRef: import("react").RefObject<any>, disabled: boolean) => void;
